...
function renderWhatChanged() {
  ...
  if (feed.baseline && !items.length) {
    return `<section class="changes-v09">
      <div class="changes-intro"><div><div class="eyebrow">What Changed? · v0.9.1</div><h3>Decision baseline captured</h3><p>The toolkit now persists decision state. The next collection will surface only material changes in lineup, availability, role evidence, waivers, planning and H2H context.</p></div></div>
    </section>`;
  }
  return `<section class="changes-v09">
    <div class="changes-intro">
      <div><div class="eyebrow">What Changed? · v0.9.1</div><h3>Since ${esc(changeTimeLabel(feed.since))}</h3><p>Correlated changes for the same player are grouped into one decision card. Small score movement is deliberately suppressed.</p></div>
