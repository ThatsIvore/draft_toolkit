...
def test_public_h2h_keeps_team_names_but_redacts_manager_identity():
    player = {
        "player_id": 1,
        "player": "Alpha",
        "owner_raw": 502,
    ...
    assert opponent["display_name"] == "Opponent XI"
    ...
    assert future == {"display_name": "Future Opponent"}
    assert public["h2h_outlook"]["summary"]["toughest_matchup"]["opponent"] == "Future Opponent"
    assert public["h2h_outlook"]["summary"]["best_opportunity"]["opponent"] == "Another Opponent"
